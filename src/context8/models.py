...
class RawDocument(_StrictModel):
    """Raw document contents fetched from a local file or remote source.

    Attributes:
        source: Original source path or URL used to fetch the document.
        body: Raw response body or file contents.
        content_type: MIME type associated with the fetched document.
    """

    source: NonEmptyStr = Field(description="Original source path or URL used to fetch the document.")
    body: NonEmptyStr = Field(description="Raw response body or file contents.")
    content_type: NonEmptyStr = Field(description="MIME type associated with the fetched document.")
